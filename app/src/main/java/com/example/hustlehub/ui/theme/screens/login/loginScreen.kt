package com.example.hustlehub.ui.theme.screens.login
...
import com.example.hustlehub.navigation.ROUTE_REGISTER
...
fun LoginScreen(navController: NavController){
    ...
    Column (modifier = Modifier.fillMaxHeight().fillMaxWidth(), verticalArrangement = Arrangement.Center){
        ...
        Spacer(modifier = Modifier.height(10.dp))
        Button(onClick = {
            authViewModel.login(email,password, navController as NavHostController, context)
